...
public class MessageHandler implements GameInterface {
	...
	public MessageHandler(Application app, TextureAtlas atlas) {
		...
		//Init messages
//		messages.add(new Message(2f, 6, messageStrings[0], messageTex.getRegionHeight(), messageTex.getRegionWidth(), 32));
//		messages.add(new Message(0.4f, 6, messageStrings[1], messageTex.getRegionHeight(), messageTex.getRegionWidth(), 64));
//		messages.add(new Message(0.4f, 6, messageStrings[2], messageTex.getRegionHeight(), messageTex.getRegionWidth(), 22));
//		messages.add(new Message(0.4f, 6, messageStrings[3], messageTex.getRegionHeight(), messageTex.getRegionWidth(), 14));
//		messages.add(new Message(0.4f, 6, messageStrings[4], messageTex.getRegionHeight(), messageTex.getRegionWidth(), 0));
		messages.add(new Message(0.4f, 6, messageStrings[5], messageTex.getRegionHeight(), messageTex.getRegionWidth(), 32));
	}
